...
const camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 30); // create a camera and pass field of view, aspect ratio(window.innerWidth / window.innerHeight), near (anything closest than that distance you will not see), far (anything further than that distance you will not see too)
